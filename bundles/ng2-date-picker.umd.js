...
var DatePickerComponent = (function () {
    ...
    DatePickerComponent.prototype.onViewDateChange = function (value) {
        var /** @type {?} */ strVal = value ? this.utilsService.convertToString(value, this.componentConfig.format) : '';
...
var MonthCalendarService = (function () {
    ...
    MonthCalendarService.prototype.generateYear = function (config, year, selected) {
        ...
        var /** @type {?} */ inRow = config.monthInRow && 12 % config.monthInRow === 0 ? config.monthInRow : 4;
        return this.utilsService.createArray(12 / inRow).map(function () {
            return _this.utilsService.createArray(inRow).map(function () {
